...
update aluno set email="teobaldoanastacio@gmail.com" where id=1;
update aluno set email="cacildacibele@gmail.com" where id=2;
update aluno set email="paulosteffen@gmail.com" where id=3;
update aluno set email="leonardomicael@gmail.com" where id=4;
select * from aluno;
